...
def main(args: argparse.Namespace):
    ...
    for idx in trange(len(dataset)):
        ...
        vis_save_path = os.path.join(args.dataset_root, 'conceptgraph_data', args.scene_id, f"gsa_vis_{save_name}", color_path.name)
        detections_save_path = os.path.join(args.dataset_root, 'conceptgraph_data', args.scene_id, f"gsa_detections_{save_name}", color_path.name)
        detections_save_path = detections_save_path.replace(".jpg", ".pkl.gz")
    ...
    # save global classes
    with open(os.path.join(args.dataset_root, 'conceptgraph_data', args.scene_id, f"gsa_classes_{save_name}.json"), "w") as f:
