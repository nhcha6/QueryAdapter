...
def main(cfg : DictConfig):
    ...
    if use_affordances:
        ...
        train_classes = affordance_list[0:48][n_core_concepts::8] #+ top100_affordances[0::n_core_concepts] + top100_descriptions[1::n_core_concepts]
    else:
        # train_classes = top50[n_core_concepts::10]
        train_classes = top100[0:48][n_core_concepts::8] #+ top100_affordances[0::n_core_concepts] + top100_descriptions[1::n_core_concepts]

    print(n_core_concepts)
    print(train_classes)
