...
for b in [256,516]:
    for l in [1e-3, 0.3e-3, 1e-4]:
        dataset_cfg = mch({
            ...
            'n_core_concepts': n_core_concpets,
        })
        ...
        train_clip_adapter(
            ...
            num_epochs=500,
            eval_every=10,
            ckpt_path=f'../../ckpt/15_Batchsize/batch_{b}_lr_{l}_core_{n_core_concpets}/',# always end with the n_core_concpets
            cfg=adapter_cfg
        )
